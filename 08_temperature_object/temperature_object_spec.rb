...
describe Temperature do
  ...
  describe "utility class methods" do
    ...
    it "should include ftoc and ctof" do
      Temperature.methods.include?(:ftoc) && Temperature.methods.include?(:ctof)
    end

    it "should be callable from the rest of the object" do
    end
  end

  describe "Temperature subclasses" do
    describe "Celsius subclass" do
      it "is constructed in degree celsius" do
